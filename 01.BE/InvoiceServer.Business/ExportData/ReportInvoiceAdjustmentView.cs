...
{
    public class ReportInvoiceAdjustmentView : IXssf
    {
        ...
        public ReportInvoiceAdjustmentView(InvoiceExport dataReports, PrintConfig config, string language)
        {
            ...
            if (language == "en")
            {
                choooseFile = "report-invoice-adjustment-en.xlsx";
            }
            else
            {
                choooseFile = "report-invoice-adjustment-vn.xlsx";
            }
