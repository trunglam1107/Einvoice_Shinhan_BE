...
this IDbConnection cnn, string sql, Func<TFirst, TSecond, TThird, TFourth, TReturn> map, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, string splitOn = "Id", int? commandTimeout = null, CommandType? commandType = null
        ...
        static IEnumerable<TReturn> MultiMapImpl<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(this IDbConnection cnn, string sql, object map, object param, IDbTransaction transaction, string splitOn, int? commandTimeout, CommandType? commandType, IDataReader reader, Identity identity)
        {
            ...
            try
            {
                ...
                {
                    SubMultiMapImpl1<TFirst, TSecond, TThird, TFourth, TFifth>(splitOn, reader, cinfo, identity, deserializer, out otherDeserializers);
                }
                ...
                if (otherDeserializers.Length > 1)
                {
                    SubMultiMapImpl2<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(otherDeserializers, mapIt, map, rootDeserializer, deserializer2);
                }
        ...
        static void SubMultiMapImpl2<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(object[] otherDeserializers, Func<IDataReader, TReturn> mapIt, object map
            , Func<IDataReader, TFirst> rootDeserializer, Func<IDataReader, TSecond> deserializer2)
        {
        ...
        static void SubMultiMapImpl1<TFirst, TSecond, TThird, TFourth, TFifth>(string splitOn, IDataReader reader, CacheInfo cinfo, Identity identity, object deserializer, out object[] otherDeserializers)
        {
            int current = 0;
        ...
        public static void PackListParameters(IDbCommand command, string namePrefix, object value)
        {
            ...
            if (list != null)
            {
                ...
                {
                    count++;
                    PackListParametersItem(command, namePrefix, item, isString, count);
                }
        ...
        private static void PackListParametersItem(IDbCommand command, string namePrefix, object item, bool isString, int count)
        {
        ...
        private static Action<IDbCommand, object> CreateParamInfoGenerator(Identity identity)
        {
            ...
            {
                CreateParamInfoGeneratorItem(identity, il, prop, ref haveInt32Arg1);
            }
        ...
        private static bool CreateParamInfoGeneratorItem(Identity identity, ILGenerator il, PropertyInfo prop, ref bool haveInt32Arg1)
        {
            bool filterParams = identity.commandType.GetValueOrDefault(CommandType.Text) == CommandType.Text;
            ...
            if (checkForNull)
            {
                SubCreateParamInfoGeneratorItem(identity, il, prop, ref haveInt32Arg1, dbType);
            }
        ...
        private static void SubCreateParamInfoGeneratorItem(Identity identity, ILGenerator il, PropertyInfo prop, ref bool haveInt32Arg1, DbType dbType)
        {
...
IDataReader reader, int startBound = 0, int length = -1, bool returnNullIfFirstMissing = false
...
)
        {
            ...
            foreach (var item in setters)
            {
                ...
                {
                    SubGetClassDeserializer1(item, il, allDone, ref haveEnumLocal, index, first, returnNullIfFirstMissing);
                }
                first = false;
                index += 1;
            }
        ...
        public static void SubGetClassDeserializer1(dynamic item, ILGenerator il, Label allDone, ref bool haveEnumLocal, int index, bool first, bool returnNullIfFirstMissing)
        {
            ...
            {
                SubGetClassDeserializer2(item, memberType, il, isDbNullLabel, finishLabel, ref haveEnumLocal);
            }
        ...
        public static void SubGetClassDeserializer2(dynamic item, Type memberType, ILGenerator il, Label isDbNullLabel, Label finishLabel, ref bool haveEnumLocal)
        {
